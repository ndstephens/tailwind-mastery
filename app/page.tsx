    ...
    <main>
      <div className="flex h-screen text-gray-100">
        <div className="space-y-2 overflow-y-scroll bg-gray-900 p-3">
          <div className="flex aspect-square w-12 items-center justify-center rounded-[24px] bg-gray-700 text-gray-100 transition-all duration-200 hover:rounded-2xl hover:bg-brand hover:text-white">
...
function DiscordIcon(props: PropsWithoutRef<JSX.IntrinsicElements['svg']>) {
  return (
