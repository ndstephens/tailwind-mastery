...
export function Bell(props: PropsWithoutRef<JSX.IntrinsicElements['svg']>) {
  return (
...
export function Pin(props: PropsWithoutRef<JSX.IntrinsicElements['svg']>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function People(props: PropsWithoutRef<JSX.IntrinsicElements['svg']>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
...
export function Inbox(props: PropsWithoutRef<JSX.IntrinsicElements['svg']>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      <path
